...
import { reqUpdateProduct } from '../redux/action/actionReduce';
...
const EditProduct = (props:any) => {
  ...
  const handleUpload = (data:any) => {
    ...
    DataBaru.append('product_id', props.product.id);
    DataBaru.append('file', data.file[0]);
    DataBaru.append('name', data.name);
    DataBaru.append('description', data.description);
    DataBaru.append('categoryid', data.categoryid);
    DataBaru.append('price', data.price);
    // console.log(DataBaru)
    dispatch(reqUpdateProduct(DataBaru));
  };
